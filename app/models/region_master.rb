class RegionMaster < ApplicationRecord
    ...
    has_many :polling_stations, class_name:"PollingStationMaster",primary_key: :region_id
    has_many :political_parties, class_name:"PoliticalPartyMaster",primary_key: :region_id
    # has_many :polling_stations, class_name:"PollingStationMaster",primary_key: :region_id
