class PoliticalPartyMastersController < ApplicationController
  ...
  private
    ...
    def political_party_master_params
      params.require(:political_party_master).permit(:political_party_id, :region_id, :city, :name, :party_initial, :contact_number, :email_address, :party_logo, :image_path, :hq_address_line_1, :hq_address_line_2, :district_id, :town_id, :gps_coordinates, :active_status, :del_status, :user_id)
    end
end
